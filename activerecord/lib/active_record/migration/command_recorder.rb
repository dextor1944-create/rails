...
module ActiveRecord
  class Migration
    ...
    class CommandRecorder
      ...
      # Records +command+ with its +args+ and +kwargs+. +command+ is a method
      # name (symbol), +args+ is an array of positional arguments, and +kwargs+
      # is a hash of keyword arguments. For example:
      #
      #   recorder.record(:method_name, [:arg1, :arg2], { key: :value })
